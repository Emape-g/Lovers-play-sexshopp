...
import { fetchProductosPorCategoria } from "@/lib/services/api"
...
export default function HomePage() {
  ...
  useEffect(() => {
    // 🔹 Cargar productos destacados (ejemplo: categoría 64)
    fetchProductosPorCategoria(64)
      .then(setFeaturedProducts)
      .catch((err) => console.error("Error cargando destacados:", err))

    // 🔹 Cargar productos más vistos (ejemplo: categoría 65)
    fetchProductosPorCategoria(65)
