...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      details: ["info@loversplay.com", "soporte@loversplay.com"],
      description: "Respuesta en menos de 24 horas",
    },
    {
      icon: MapPin,
      title: "Dirección",
      details: ["123 Calle Principal", "Ciudad, País 12345"],
            ...
            <Card className="bg-gradient-to-br from-brand/10 to-brand/5 border-brand/20">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4 font-[family-name:var(--font-inter)]">
                  Consulta nuestras preguntas frecuentes o revisa la información de envíos
                </p>
                <div className="space-y-2">
            ...
            <CardContent className="p-0">
              <div className="bg-muted rounded-lg h-64 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground font-[family-name:var(--font-inter)]">Mapa de ubicación</p>
                </div>
              </div>
            </CardContent>
          </Card>
